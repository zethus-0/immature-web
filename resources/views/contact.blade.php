...
<div class="h-full w-full overflow-hidden flex items-center justify-center">
    <form class="p-3 bg-white bg-opacity-50 rounded max-w-lg">
  ...
  <div class="md:flex md:items-center">
    <div class="md:w-1/3">
      <button class="p-2 lg:px-4 md:mx-2 text-indigo-600 text-center border border-solid border-indigo-600 rounded hover:bg-indigo-600 hover:text-white transition-colors duration-300 mt-1 md:mt-0 md:ml-1" type="button">
        Send
      </button>
    </div>
